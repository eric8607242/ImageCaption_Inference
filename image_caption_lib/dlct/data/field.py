...
class TextField(RawField):
    ...
    def __init__(self, path_to_vocab_stoi, path_to_vocab_itos, use_vocab=True, 
                 init_token=None, eos_token=None, fix_length=None, dtype=torch.long,
        ...
        with open(path_to_vocab_stoi, "r") as f:
            self.stoi = json.load(f)
        with open(path_to_vocab_itos, "r") as f:
    ...
    def numericalize(self, arr, device=None):
        ...
        if self.use_vocab:
            arr = [[self.stoi[x] for x in ex] for ex in arr]
